...
extern byte apsReflectMsg( zAddrType_t *SrcAddress,
                           aps_FrameFormat_t *aff, uint8_t LinkQuality,
                           uint8_t ackReq, uint8_t SecurityUse,
...
extern void apsGenerateAck( uint16_t dstAddr, aps_FrameFormat_t *aff );

extern void apsProcessAck( uint16_t srcAddr, aps_FrameFormat_t *aff );
